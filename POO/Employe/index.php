...
$employe[] = new Employe(array("nom"=>"Toto","prenom"=>"Tata","dateEmbauche"=>"2012-09-11","poste"=>"employe","salaire"=>12,"service"=>"cuisine","Agence"=>$agence1));
$employe[] = new Employe (array("Nom"=>"Deschamps","Prenom"=>"Didier","dateEmbauche"=>"2021-01-01","poste"=>"employe","salaire"=>38,"Service"=>"soudeur","Agence"=>$agence3));
$employe[] = new Employe (array("Nom"=>"Deuf","Prenom"=>"John","dateEmbauche"=>"2020-03-12","poste"=>"employe","salaire"=>60,"Service"=>"serveur","Agence"=>$agence2));
$employe[] = new Employe (array("Nom"=>"Duriff","Prenom"=>"Sylvain","dateEmbauche"=>"2017-06-11","poste"=>"employe","salaire"=>72,"Service"=>"grand monarque","Agence"=>$agence1));
$employe[] = new Employe (array("Nom"=>"Sarkozy","Prenom"=>"Nico","dateEmbauche"=>"2015-07-06","poste"=>"employe","salaire"=>5,"Service"=>"boulanger","Agence"=>$agence3));
...
echo "La masse salariale est de :".$masseSalariale."€";
//tickets restaurants
foreach ($employe as $e) {
    echo "Mode de restauration pour ".$e->getAgence()->getRestauration()."\n";    
}
foreach ($employe as $e ) {
