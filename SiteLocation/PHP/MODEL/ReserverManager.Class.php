...
public static function add(Reserver $objet){
    $db = DbConnect::getDb();
    $q = $db->prepare("INSERT INTO Reserver(idUser,idVoiture,idAgence,dateReservation,dateDebutReservation,dateFinReservation,quantite,) VALUES (:idUser,:idVoiture,:idAgence,:dateReservation,:dateDebutReservation,:dateFinReservation,:quantite,)");
