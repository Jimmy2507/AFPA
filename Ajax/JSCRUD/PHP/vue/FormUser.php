...
echo $sousTitre;
echo '<form id="formulaire" method="post" action="?page=ActionUser&mode='. $mode .'">';
...
echo '
            ...
            <div class="input"> <input type="text" name="username" value="' . $user->getUsername() . '" ' . $dis . '></div>
            </div>
            <div class="ligneDetail">
